# Generated by Powerlevel10k configuration wizard on 2023-09-27 at 12:29 +07.
...
() {
  ...
  #   - P9K_KUBECONTEXT_CLOUD_CLUSTER=my-cluster-01
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_CONTENT_EXPANSION='${P9K_KUBECONTEXT_CLOUD_NAME:-local}:${P9K_KUBECONTEXT_CLOUD_ACCOUNT}:'
 ...
 # Google cloud color.
  ...
  typeset -g POWERLEVEL9K_GCLOUD_PARTIAL_CONTENT_EXPANSION='${CLOUDSDK_ACTIVE_CONFIG_NAME:-${P9K_GCLOUD_PROJECT_ID//\%/%%}}'
  typeset -g POWERLEVEL9K_GCLOUD_COMPLETE_CONTENT_EXPANSION='${CLOUDSDK_ACTIVE_CONFIG_NAME:-${P9K_GCLOUD_PROJECT_NAME//\%/%%}}'
